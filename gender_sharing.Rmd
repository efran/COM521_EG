...
summary(glm(got.love ~ female + log1p(prev.projects), data=info_data, family=binomial("logit")))
```
...
summary(glm(shared ~ log1p(prev.projects) + log1p(previous.total.love), data=info_data, family=binomial("logit")))
```
...
summary(glm(shared ~ female + log1p(prev.projects) + log1p(previous.total.love) + female * got.love, data=info_data, family=binomial("logit")))
```
